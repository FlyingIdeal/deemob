<template>
  <div>
    <Card dis-hover class="page-main" :bordered="false">
      ...
      <h2 v-show="!disable" class="page-title">账号审核详情页
            ...
            <div v-if="from==='log'">
              <div class="form_content">
                <FormItem class="accountForm" label="审核状态">
                  ...
                  <p v-if="account_info.status===2" class="text" style="color: #F93D3D">已拒绝</p>
                </FormItem>
              </div>
              <div class="form_content">
                <FormItem v-show="account_info.status===2" class="accountForm" style="width: 100%" label="拒绝原因">
