...
1.0.0  只创意审核
1.0.1  正式开发管理平台
1.2.0  账号权限2021/1/6（2021/1/18再次记录，已合并到1.3.0）
1.3.0  RTA需求（创建时间: 2021/1/18日； 已合并到主线2021.1.21日）
1.3.1  代理商和广告位列表增加rta筛选（创建时间，2021.1.21日； 1.21开发完成，已合并到1.3.0）（2021.2.7日删除）
1.4.0  产品需求：1. 广告位去除cpm,cpc底价； 2. 收入数据导入； 已合并上线）
1.4.1  产品需求： 批量审核创意 （已合并上线）
1.4.2  链接录入-广告创意ID （创建时间2021/3/11, 已上线）
```
...
v1.0.1版本
<RadioGroup v-model="formBase.adType" type="button" @on-change="validateField">
    <Radio :label="1">广告类型1</Radio>
    <Radio :label="2">广告类型2</Radio>
</RadioGroup>
