...
class HttpRequest {
    constructor(baseUrl = baseURL) {
        ...
        this.noErrMesApiList = ['/user/info', '/user_sys/role', '/base/upload', '/user/session_verify', '/ssp/app/import', '/ssp/slot/import', '/import/add_income_list'] // 不需要弹错误的api
    ...
    interceptors(instance, options) {
        ...
        instance.interceptors.response.use(response => {
            ...
            let _resUrl = _splitUrl.split('/v1')[1] // url拆分
    ...
    showErrMes(code, msg) {
        ...
        switch (code) {
            ...
            case 403: errMes = '未经授权，拒绝访问(403)'; break
