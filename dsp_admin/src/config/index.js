export default {
    ...
    APIUrl: {
        // dev: { // 开发环境 - 切换到灰度环境
        //     baseUrl: 'http://operate.dev.deemob.com', // 基础请求接口
        ...
        // },
        dev: { // 灰度
            baseUrl: 'https://operate.gray.deemob.com', // 基础请求接口
        ...
        testing: { // 测试服务器
            baseUrl: 'http://operate.test.deemob.com', // 基础请求接口
        ...
        pro: { // 正式服务器
            baseUrl: 'https://operate.deemob.com', // 基础请求接口
