...
export default {
    ...
    getters: {
        ...
        getStrategy: state => state.strategyArr, // 付款策略
        getIsTestSlot: state => state.isTestSlot, // 是否是测试广告位
        getIsRta: state => state.isRtaList // 是否是RTA类型
    },
    mutations: {
