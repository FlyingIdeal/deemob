    ...
    <div class="main_info">
      <div class="info_left">
        ...
        <div class="info_data boxShadow">
          <div class="account">
            ...
            <div class="account_list" style="border: 0px">
      ...
      <div class="info_right boxShadow">
        <div class="right_title">
          ...
          <div>
            <Select v-model="dataTime" @on-change="keyTimeChange" class="i-margin-right-11" style="width:104px">
        ...
        <div class="right_list">
          <div class="data_list">
            ...
            <div class="data_text" v-show="keyDataList.length>0">
              <p class="title">
                广告展现
                <span  :class="[{'up_scale': keyDataList[0].view_seq >= 10, 'down_scale' : keyDataList[0].view_seq <= -10}]">
                 <Icon v-if="keyDataList[0].view_seq >= 10 || keyDataList[0].view_seq <= -10"
                       :type="keyDataList[0].view_seq >= 10 ? 'md-arrow-round-up': 'md-arrow-round-down'"/>
          ...
          <div class="data_list">
            ...
            <div class="data_text">
              <p class="title">
                广告点击
                <span
                  :class="[{'up_scale': keyDataList[0].click_seq >= 10, 'down_scale' : keyDataList[0].click_seq <= -10}]">
                 <Icon v-if="keyDataList[0].click_seq >= 10 || keyDataList[0].click_seq <= -10"
                       :type="keyDataList[0].click_seq >= 10 ? 'md-arrow-round-up': 'md-arrow-round-down'"/>
          ...
          <div class="data_list" style="border:0px">
            <div class="data_icon">
            ...
            <div class="data_text">
              <p class="title">点击率
                <span
                  :class="[{'up_scale': keyDataList[0].ctr_seq >= 10, 'down_scale' : keyDataList[0].ctr_seq <= -10}]">
                 <Icon v-if="keyDataList[0].ctr_seq >= 10 || keyDataList[0].ctr_seq <= -10"
                       :type="keyDataList[0].ctr_seq >= 10 ? 'md-arrow-round-up': 'md-arrow-round-down'"/>
          ...
          <div class="data_list" >
            ...
            <div class="data_text">
              <p class="title">花费
                <span
                  :class="[{'up_scale': keyDataList[0].report_spend_seq >= 10, 'down_scale' : keyDataList[0].report_spend_seq <= -10}]">
                 <Icon v-if="keyDataList[0].report_spend_seq >= 10 || keyDataList[0].report_spend_seq <= -10"
                       :type="keyDataList[0].report_spend_seq >= 10 ? 'md-arrow-round-up': 'md-arrow-round-down'"/>
          ...
          <div class="data_list">
            ...
            <div class="data_text">
              <p class="title">千次展示均价
                <span
                  :class="[{'up_scale': keyDataList[0].ecpm_seq >= 10, 'down_scale' : keyDataList[0].ecpm_seq <= -10}]">
                 <Icon v-if="keyDataList[0].ecpm_seq >= 10 || keyDataList[0].ecpm_seq <= -10"
                       :type="keyDataList[0].ecpm_seq >= 10 ? 'md-arrow-round-up': 'md-arrow-round-down'"/>
          ...
          <div class="data_list" style="border:0px">
            ...
            <div class="data_text">
              <p class="title">点击均价
                <span
                  :class="[{'up_scale': keyDataList[0].cpc_seq >= 10, 'down_scale' : keyDataList[0].cpc_seq <= -10}]">
                 <Icon v-if="keyDataList[0].cpc_seq >= 10 || keyDataList[0].cpc_seq <= -10"
                       :type="keyDataList[0].cpc_seq >= 10 ? 'md-arrow-round-up': 'md-arrow-round-down'"/>
        ...
        <div v-show="activityStatus===1" class="table_con">
          ...
          >
            ...
            <template slot-scope="{ row }" slot="show">
              <p class="table_text">{{ number2Thousand(row.view) }}</p>
            </template>
            <!--广告活动的花费-->
            <template slot-scope="{ row }" slot="cost">
              <p class="table_text">{{ number2Thousand(row.report_spend) }}</p>
            </template>
          </Table>
        </div>
        ...
        getDataEffectData(data).then(res => {
          if (res.code === 200) {
            ...
            if (list.length > 0) {
              ...
              list.length < 10 ? this.unitListStatus = false : ''
              this.unitStatus = 1
            } else {
              this.unitStatus = 2
            }
      ...
      getYesterdaySum(type, obj) {
        ...
        getDataEffectData(data).then(res => {
          if (res.code === 200) {
            ...
            data = obj
            let other = {}
            other.ordername = type === 1 ? '其他' : '其他'
            other.campaignname = type === 1 ? '其他' : '其他'
            other.view = type === 1 ? parseInt(sumData.view) - parseInt(this.unitSumView) : parseInt(sumData.view) - parseInt(this.activityView)
            other.report_spend = type === 1 ? parseFloat(sumData.report_spend) - parseFloat(this.activityCost) : parseFloat(sumData.report_spend) - parseFloat(this.unitSumCost)
            data.push(other)
        ...
        getDataEffectData(data).then(res => {
          if (res.code === 200) {
            ...
            if (list.length > 0) {
              ...
              list.length < 10 ?  this.activityListStatus = false : ''
