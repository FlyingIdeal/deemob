<template>
	<Layout class="app" style="height: 100%">
		...
		<Layout>
			<Sider class="left-bar" collapsible :width="160" :collapsed-width="56" v-model="collapsed" :style="{overflow: 'hidden'}">
...
export default {
	...
	created() {
		...
		this.marginLeft = _val === 'true' ? 56 : 160
	},
	methods: {
		/**
		 * [isKeepAlive 是否缓存]
		...
		toggleCollapsed(val) {
			...
			this.marginLeft = this.collapsed ? 56 : 160
