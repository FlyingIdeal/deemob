<template>
    <div>
        ...
        <!--配置弹窗-->
        <Drawer class="setModal" title="配置" v-model="setModalFlag" :mask-closable="false" :closable="false" class-name="vertical-center-modal" width="600" :styles="drawStyles">
            <Form :label-width="120" ref="setModalForm" :model="setModalForm" :rules="setRuls">
...
import { getUnion, randomNumber } from '@/libs/tools'
